            ...
            <div className="max-w-4xl">
              ...
              <TextRevealByLine delay={0.1}>
                <h1 className="heading-display mb-8">
                  The <span className="text-primary">Minds</span> Behind Our Work
                </h1>
              </TextRevealByLine>
              <TextRevealByLine delay={0.2}>
                <p className="body-large max-w-2xl">
                  Our diverse team of architects, engineers, and designers brings 
              ...
              {leadership.map((person) => (
                <StaggerItem key={person.name}>
                  ...
                  >
                    ...
                    <span className="label-uppercase text-xs block mb-4">{person.role}</span>
        ...
        <section className="section-padding bg-card">
          <div className="container-architectural">
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
              <div>
                <TextReveal>
                  <span className="label-uppercase mb-4 block">Organization</span>
                </TextReveal>
                <TextRevealByLine delay={0.1}>
                ...
                <TextRevealByLine delay={0.2}>
                  <p className="body-large">
                    85+ professionals across 5 specialized departments, 
                    working collaboratively to deliver excellence.
                  </p>
                </TextRevealByLine>
              </div>
              <div>
                      ...
                      <div className="flex items-center justify-between py-4 border-b border-border">
                        ...
                        <div className="flex items-center gap-4">
                          <motion.div 
                            ...
                            initial={{ width: 0 }}
                            whileInView={{ width: `${(dept.count / 32) * 120}px` }}
                            viewport={{ once: true }}
                            transition={{ duration: 0.8, delay: index * 0.1 }}
                          />
                          <span className="text-muted-foreground w-8 text-right">{dept.count}</span>
                        </div>
                      </div>
                    </StaggerItem>
                  ))}
